...
React.render(<CommonBox />, document.getElemenyById('content'));

var CommentList = React.createClass({
  render: function() {
    return (
        <div className="commentList">Hi! </div>
    );
  }
});
...
var CommentForm = React.createClass({
  render: function() {
    return (
      <div className="commentForm">Input Form </div>
    );
  }
});
  ...
  render: function() {
    return (
      <div className="commentList">
        <Comment author="Pete Hunt">Comment</Comment>
...
var CommentBox = React.creactClass({
  render: function() {
    return (
...
React.render(
  <CommentBox data={data}, docuemnet.getElementById('content')
)
...
var CommentList = React.createClass({
  render: function() {
    return (
      <div className="commonList">Hi</div>
    )
  }
});
...
var CommentForm = React.createClass({
  render: function() {
    return (
      <div className="commentForm">Hello</div>
    );
  }
});
...
var CommentList = React.createClass({
  render: function() {
    return (
      <div className="commentList">
        <Comment author="Pete Hunt">Hi</Comment>
        <Comment author="Jordan Walke">Another Hi</Comment>
      </div>
    );
  }
});
